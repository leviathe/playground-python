...
class MyApp:
    ...
    def __init__(self):
        ...
        self.window.iconbitmap("Half-Life_PNG76.ico")
        ...
        self.create_widgets() # pour afficher les objets
    ...
    def create_subtitle(self):
        label_subtitle = Label(self.frame, text="Fait par PP", font=("Courrier", 25), bg='#41B77F',
                               fg='white')
        label_subtitle.pack()
