...
# afficher chaque film toutes les caractéristiques
for numero, film in enumerate(films, start=1): # Renvoie d'abord un numéro puis une appellation de la liste
    titre = film['titre'] #Toutes les colonnes sont déclarer dans enumerate. Ainsi on peut tout déclarer avec les mêmes variables.
    seance = film['seance']
    places = film['places']

    places_var = StringVar() # Pour variable d'affichage
    places_var.set(places) # .set modifie la valeur de la variable
